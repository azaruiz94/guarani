...
class InmueblesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inmueble" do
    assert_difference('Inmueble.count') do
      post inmuebles_url, params: { inmueble: { codigo: @inmueble.codigo, direccion: @inmueble.direccion, nombre: @inmueble.nombre } }
    end
  ...
  test "should update inmueble" do
    patch inmueble_url(@inmueble), params: { inmueble: { codigo: @inmueble.codigo, direccion: @inmueble.direccion, nombre: @inmueble.nombre } }
